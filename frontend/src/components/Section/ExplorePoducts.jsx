  ...
  return (
    ...
    <div className=' container mx-auto pb-6   px-4 overflow-x-hidden '>
        <div className='my-2 flex gap-2  items-center'>
            ...
            <h1 className='text-red-500 font-bold text-lx'>Our Products</h1>
        </div>
        <div className=' flex items-center justify-between'>
            ...
            <div className=' hidden  md:flex items-center gap-2'>
                <button onClick={() => scroll1('left') } className='bg-gray-300 h-10 w-10 flex items-center justify-around rounded-full'><FaArrowLeftLong /></button>
                <button onClick={() => scroll1("right")} className='bg-gray-300 h-10 w-10 flex items-center justify-around rounded-full'><FaArrowRightLong /></button>
            </div>
        </div>
        <div ref={scrollRef}  
        className='hidden md:flex overflow-x-scroll  py-2 px-1 snap-x snap-mandatory  scrollbar-hide my-6 gap-4 relative'>
        ...
        className='flex md:hidden overflow-x-scroll  py-2 px-1 snap-x snap-mandatory  scrollbar-hide my-6 gap-4 relative'>
            {products.map((product,index) => (
                <ProductCard key={index} product={product}/>
            ))}
